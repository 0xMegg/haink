...
export class CodeIssuer {
  async issueMasterCode(tx: Prisma.TransactionClient, issuedCategoryId: string): Promise<{ masterCode: string; sequence: number; }> {
